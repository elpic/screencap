...
if( !args.url || !args.output ) {
  var message = 'Usage: rasterize.js url=URL output=filename div=selector[optional] \n';
  message += '\twidth=width[optional] height=height[optional] ';
  message += '\tOR ';
  message += '\t top=top left=left width=width height=height\n';
...
if(!args.height) { args.height = 550; }
